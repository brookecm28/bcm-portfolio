    ...
    return (
        <div className='about'>
            <div className='about-me'>
                <div className='project-title about-title'>A Little About Me:</div>
                <p className='para'>After growing up and living in small-town Indiana for the first 18 years of my life, I took my first step in finding who I truly was by attending Purdue University.
